...
def test_how_many_off
    ...
    assert_equal(["1", "2",], how_many_off(["1234", "5554"],["1235","5545"]))
    assert_equal(["0", "0", "1", "2", "3", "4", "5"], how_many_off(["4444", "1231", "1231", "1231", "1231", "1331", "1831"],["4444", "1231", "1531", "1343", "1375", "1245", "1236"]))
end
end
